            ...
            <div>
                <Carousel>
                    <Carousel.Item>
                        ...
                        <Carousel.Caption>
                            <h1 style={{fontSize:'50px', width:'750px', textAlign:'left'}} >Hi, My Name is Lora, Wellcome to my Tinzer Clinic</h1>
                            <p style={{fontSize:'15px', width:'600px', textAlign:'left'}}  >I'm happy to answer any questions you have or provide you with an estimate. Just send us a message in the form below with any questions you may have.</p>
                        </Carousel.Caption>
                       <div className='px-3'>
